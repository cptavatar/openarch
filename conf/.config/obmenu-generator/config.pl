...
our $CONFIG = {
  ...
  "Linux::DesktopFiles" => {
                             ...
                             gtk_rc_filename         => "/home/alex/.gtkrc-2.0",
                             icon_dirs_first         => ["/usr/share/icons/Numix","/usr/share/icons/nuoveXT2","/usr/share/icons/Adwaita"],
                             icon_dirs_last          => ["/usr/share/icons/hicolor","/usr/share/icons/default"],
                             icon_dirs_second        => [],
